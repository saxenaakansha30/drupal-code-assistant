...
# App title
streamlit.set_page_config(page_title="Drupal Code Assistant")
with streamlit.sidebar:streamlit.title("Drupal Code Assistant")

llm = ollama.Ollama(model="drupal-code-assistant")
